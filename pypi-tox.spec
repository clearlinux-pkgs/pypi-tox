...
Source0  : https://files.pythonhosted.org/packages/56/1e/67eff7f2cba6432e99f6ef9292927a2f9cfdd1e0c3d5c7c99f02be52923d/tox-4.1.3.tar.gz
...
%prep
%setup -q -n tox-4.1.3
cd %{_builddir}/tox-4.1.3
pushd ..
cp -a tox-4.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672762647
