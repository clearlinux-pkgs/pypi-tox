...
Source0  : https://files.pythonhosted.org/packages/8e/81/91bb3f010dfc6539c63e600c762369d4ef67432d00f69ea2dc50a1f3cd0b/tox-4.1.1.tar.gz
...
%prep
%setup -q -n tox-4.1.1
cd %{_builddir}/tox-4.1.1
pushd ..
cp -a tox-4.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672418714
