...
Source0  : https://files.pythonhosted.org/packages/4b/47/2624a2644b2fff805009a282a79721aff001f20ec603e3f32d750cf0e146/tox-4.0.14.tar.gz
...
%prep
%setup -q -n tox-4.0.14
cd %{_builddir}/tox-4.0.14
pushd ..
cp -a tox-4.0.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671478126
