...
Source0  : https://files.pythonhosted.org/packages/ca/87/d17a1863aadeb6f1a4e965b361ef5c68a377ff34ae9e108c4d22a59e7b10/tox-4.0.17.tar.gz
...
%prep
%setup -q -n tox-4.0.17
cd %{_builddir}/tox-4.0.17
pushd ..
cp -a tox-4.0.17 buildavx2
cp -a tox-4.0.17 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672083722
