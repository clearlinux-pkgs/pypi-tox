...
Source0  : https://files.pythonhosted.org/packages/d9/92/385f9ff20bc11e436ac50839948e5cbdd4c0d3835792e3d55ae067bf3455/tox-4.3.4.tar.gz
...
%prep
%setup -q -n tox-4.3.4
cd %{_builddir}/tox-4.3.4
pushd ..
cp -a tox-4.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674056642
