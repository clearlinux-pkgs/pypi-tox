...
Source0  : https://files.pythonhosted.org/packages/bc/72/e799ba961ce78daefe170e2c5da87813bc9084e25151d81c577fbf3fe2be/tox-4.2.4.tar.gz
...
%prep
%setup -q -n tox-4.2.4
cd %{_builddir}/tox-4.2.4
pushd ..
cp -a tox-4.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672970086
