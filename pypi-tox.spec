...
Source0  : https://files.pythonhosted.org/packages/a8/e8/0042a7ab15087a540d111b0002977a52392cfcefa0099360c272ad6444c3/tox-4.4.5.tar.gz
...
%prep
%setup -q -n tox-4.4.5
cd %{_builddir}/tox-4.4.5
pushd ..
cp -a tox-4.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675885703
