...
Source0  : https://files.pythonhosted.org/packages/0e/7c/6b4efc5a23ae3be645017edba2c9e83a65244f9ecf8775c99ed5b4d82acd/tox-4.12.1.tar.gz
...
%prep
%setup -q -n tox-4.12.1
cd %{_builddir}/tox-4.12.1
pushd ..
cp -a tox-4.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705503736
