...
Source0  : https://files.pythonhosted.org/packages/fd/3c/dcec0c00321a107f7f697fd00754c5112572ea6dcacb40b16d8c3eea7c37/tox-4.26.0.tar.gz
...
%prep
%setup -q -n tox-4.26.0
cd %{_builddir}/tox-4.26.0
pushd ..
cp -a tox-4.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747233356
