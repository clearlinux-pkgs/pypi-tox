...
Source0  : https://files.pythonhosted.org/packages/b7/7e/94a8cc264b9d2674d6ce7dccaa7cebe66d0f4262d6423ab9797b071d31d5/tox-4.16.0.tar.gz
...
%prep
%setup -q -n tox-4.16.0
cd %{_builddir}/tox-4.16.0
pushd ..
cp -a tox-4.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049341
