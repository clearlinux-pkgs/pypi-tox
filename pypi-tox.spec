...
Source0  : https://files.pythonhosted.org/packages/9b/a2/443a7822a0a26bcb7898da67f72cd3d1bfe3852d00dbf72544e3382131fc/tox-4.4.3.tar.gz
...
%prep
%setup -q -n tox-4.4.3
cd %{_builddir}/tox-4.4.3
pushd ..
cp -a tox-4.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675183509
