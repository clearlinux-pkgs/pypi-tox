...
Source0  : https://files.pythonhosted.org/packages/63/46/281da99b9c25b666a13886ea358ff0264f24c6f1f5c18a850132326d77b5/tox-4.1.2.tar.gz
...
%prep
%setup -q -n tox-4.1.2
cd %{_builddir}/tox-4.1.2
pushd ..
cp -a tox-4.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672690943
