...
Source0  : https://files.pythonhosted.org/packages/ac/ee/3115a77ce5af5ac0c5262bee45bdc2d36c02cad13723d7cec970270ccb59/tox-4.0.19.tar.gz
...
%prep
%setup -q -n tox-4.0.19
cd %{_builddir}/tox-4.0.19
pushd ..
cp -a tox-4.0.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672333265
