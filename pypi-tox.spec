...
Source0  : https://files.pythonhosted.org/packages/e2/a6/c4d4dbdc0e6af2c65134bd16ff3c4c0705144784643aa3df31524a476bd2/tox-4.3.5.tar.gz
...
%prep
%setup -q -n tox-4.3.5
cd %{_builddir}/tox-4.3.5
pushd ..
cp -a tox-4.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674150064
