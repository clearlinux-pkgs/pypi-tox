...
Source0  : https://files.pythonhosted.org/packages/41/81/392c127a9fc74e765fa24e87e7c00d70520e78d05018cc78fe3266f2fb09/tox-4.0.12.tar.gz
...
%prep
%setup -q -n tox-4.0.12
cd %{_builddir}/tox-4.0.12
pushd ..
cp -a tox-4.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671232010
