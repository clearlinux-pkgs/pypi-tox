...
Source0  : https://files.pythonhosted.org/packages/d7/75/02b8654c1150a05f4f3967e470b459b07937cba862d698d5b02765f971cc/tox-4.4.6.tar.gz
...
%prep
%setup -q -n tox-4.4.6
cd %{_builddir}/tox-4.4.6
pushd ..
cp -a tox-4.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677017208
