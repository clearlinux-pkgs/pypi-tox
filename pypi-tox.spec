...
Source0  : https://files.pythonhosted.org/packages/49/58/54500bcc3118b538ff07a333347dabb947e1fe5b28564620ffe29b417a9e/tox-4.2.8.tar.gz
...
%prep
%setup -q -n tox-4.2.8
cd %{_builddir}/tox-4.2.8
pushd ..
cp -a tox-4.2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673541444
