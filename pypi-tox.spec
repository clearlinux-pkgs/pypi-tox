...
Source0  : https://files.pythonhosted.org/packages/52/cb/16711c38f6503e8cd8c691a7b5500364fb0d7ee32a79fc3f8929968cd519/tox-3.25.1.tar.gz
...
%prep
%setup -q -n tox-3.25.1
cd %{_builddir}/tox-3.25.1
pushd ..
cp -a tox-3.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656599605
...
cp %{_builddir}/tox-3.25.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tox/e7fd7c458df3ba9633d648e0d666e348689f3559
