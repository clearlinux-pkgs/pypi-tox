...
Source0  : https://files.pythonhosted.org/packages/cf/7b/97f757e159983737bdd8fb513f4c263cd411a846684814ed5433434a1fa9/tox-4.24.1.tar.gz
...
%prep
%setup -q -n tox-4.24.1
cd %{_builddir}/tox-4.24.1
pushd ..
cp -a tox-4.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737496052
