...
Source0  : https://files.pythonhosted.org/packages/fe/87/692478f0a194f1cad64803692642bd88c12c5b64eee16bf178e4a32e979c/tox-4.25.0.tar.gz
...
%prep
%setup -q -n tox-4.25.0
cd %{_builddir}/tox-4.25.0
pushd ..
cp -a tox-4.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743099077
