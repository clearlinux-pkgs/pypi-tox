...
Source0  : https://files.pythonhosted.org/packages/85/30/a2004e7e6fb71ce3fc3427262e23709b7ccd103dabc9f9b4bab92cb49e48/tox-4.4.2.tar.gz
...
%prep
%setup -q -n tox-4.4.2
cd %{_builddir}/tox-4.4.2
pushd ..
cp -a tox-4.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674750354
