...
Source0  : https://files.pythonhosted.org/packages/c9/c4/24848a844c3bfebb761d9f19b2bb4a67b24e884c3aedc6a059c5b4652716/tox-4.3.3.tar.gz
...
%prep
%setup -q -n tox-4.3.3
cd %{_builddir}/tox-4.3.3
pushd ..
cp -a tox-4.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673917637
