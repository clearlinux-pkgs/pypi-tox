...
Source0  : https://files.pythonhosted.org/packages/46/fb/c7d68c952feccbd3dfd36ecdba54a424eea0e5d6ca0d9cdb9e9581915e79/tox-4.0.18.tar.gz
...
%prep
%setup -q -n tox-4.0.18
cd %{_builddir}/tox-4.0.18
pushd ..
cp -a tox-4.0.18 buildavx2
cp -a tox-4.0.18 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672197677
