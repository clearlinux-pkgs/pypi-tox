...
Source0  : https://files.pythonhosted.org/packages/39/00/3f491691cd6b4497354a3df20485bb5de2f251ded61c5cbea76f2e2cf8a6/tox-4.4.4.tar.gz
...
%prep
%setup -q -n tox-4.4.4
cd %{_builddir}/tox-4.4.4
pushd ..
cp -a tox-4.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675208596
