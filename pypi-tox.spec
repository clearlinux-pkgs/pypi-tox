...
Source0  : https://files.pythonhosted.org/packages/2e/cd/2a9854543d8f4cde485690177fad791821a10ff45b5b3d380b93a38ddba5/tox-4.0.15.tar.gz
...
%prep
%setup -q -n tox-4.0.15
cd %{_builddir}/tox-4.0.15
pushd ..
cp -a tox-4.0.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671499519
