...
Source0  : https://files.pythonhosted.org/packages/60/c3/5f7e855a0a861b9561e535751e0653ce19b4b0af0836dee669ce0c0cf93e/tox-4.0.16.tar.gz
...
%prep
%setup -q -n tox-4.0.16
cd %{_builddir}/tox-4.0.16
pushd ..
cp -a tox-4.0.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671643497
