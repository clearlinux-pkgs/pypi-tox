...
Source0  : https://files.pythonhosted.org/packages/a3/fa/8db916f95eaddeb5fac771f403eb6b0d448e7e1a82a6a33f4827a456ddc1/tox-4.13.0.tar.gz
...
%prep
%setup -q -n tox-4.13.0
cd %{_builddir}/tox-4.13.0
pushd ..
cp -a tox-4.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708445461
