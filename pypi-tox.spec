...
Source0  : https://files.pythonhosted.org/packages/ad/65/5afee4b3e6d3fd242340b3c3a1d787f987c0aabe2597f6c7c44b04be6c51/tox-4.4.7.tar.gz
...
%prep
%setup -q -n tox-4.4.7
cd %{_builddir}/tox-4.4.7
pushd ..
cp -a tox-4.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678721668
