...
Source0  : https://files.pythonhosted.org/packages/8f/e2/98cbdadaa14d53b0f37ffcf4cbb1652ffb21f8b2f300e43f17167136af1c/tox-4.14.2.tar.gz
...
%prep
%setup -q -n tox-4.14.2
cd %{_builddir}/tox-4.14.2
pushd ..
cp -a tox-4.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711241021
