...
Source0  : https://files.pythonhosted.org/packages/70/c4/74a995db95714ead327f30933290fd04a6be9489fb0adbcef8c6f816a3d4/tox-4.2.6.tar.gz
...
%prep
%setup -q -n tox-4.2.6
cd %{_builddir}/tox-4.2.6
pushd ..
cp -a tox-4.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673283576
