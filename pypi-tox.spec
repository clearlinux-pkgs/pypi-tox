...
Source0  : https://files.pythonhosted.org/packages/5a/ed/8ac59f9062ccea7367cb0996de7f6b2adad4af6c4428527f14b61ef3cbb4/tox-4.3.2.tar.gz
...
%prep
%setup -q -n tox-4.3.2
cd %{_builddir}/tox-4.3.2
pushd ..
cp -a tox-4.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673893180
