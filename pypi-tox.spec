...
Source0  : https://files.pythonhosted.org/packages/fc/b5/a72a533fa98b980c3fa4cae42414f9419937b8c7a1170c9f426551b93668/tox-4.0.8.tar.gz
...
%prep
%setup -q -n tox-4.0.8
cd %{_builddir}/tox-4.0.8
pushd ..
cp -a tox-4.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670884945
