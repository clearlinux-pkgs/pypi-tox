...
Source0  : https://files.pythonhosted.org/packages/31/76/7f922f131b617183969c02a3b661232d7d1ae2b1e70ed22baea31d68884f/tox-4.2.1.tar.gz
...
%prep
%setup -q -n tox-4.2.1
cd %{_builddir}/tox-4.2.1
pushd ..
cp -a tox-4.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672851183
