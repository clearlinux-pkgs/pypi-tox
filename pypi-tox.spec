...
Source0  : https://files.pythonhosted.org/packages/b2/20/755c6633aff141720933cc7ae2e04fcff0465e6221164edf3b8a6b96b752/tox-4.15.1.tar.gz
...
%prep
%setup -q -n tox-4.15.1
cd %{_builddir}/tox-4.15.1
pushd ..
cp -a tox-4.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717701286
